...
<body style="background-color: #008b8b;">
	...
	<center>
		<iframe src="otherpay.php" frameborder="0" style="magin: left 10px; background-color:white"></iframe>
		<br>
		<br>
		<br>
		...
		<form action="" method="post" style="color:white;">
			...
			<br>
			<strong>MPESA message code</strong>:<br>
			<br>
			<input style="color:black;" class="form-group" type="text" name="code" placeholder="mpesa message code">
			<br>

			<br><br>
			<input class="btn btn-primary" name="submit" type="submit" value="Pay" onclick="callAPI()">
			<br>
